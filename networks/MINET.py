...
class SR_Branch(nn.Module):
    def __init__(self,n_resgroups,n_resblocks,n_feats,in_chans=3,conv=default_conv):
        ...
        self.last_conv = nn.Conv2d(n_feats*(n_resgroups+1)*2, n_feats, 3, 1, 1)
...
class MINet(nn.Module):
    def __init__(self, n_resgroups,n_resblocks, n_feats, in_chans=3):
