...
class WindowAttentionDual(nn.Module):
...
class EqualConv2d(nn.Module):
    def __init__(
        self, in_channel, out_channel, kernel_size, stride=1, padding=0, bias=True, bias_init_val=0
    ):
        super().__init__()
        ...
        if bias:
            self.bias = nn.Parameter(torch.zeros(out_channel).fill_(bias_init_val))
